 ...
 */
    ...
    public class ShroomzPsyCard extends BasicCard {


        public static final int IMAGE_NUMBER = 16;
        private Animation pareFoundAnim;

        public ShroomzPsyCard(Collection<BasicCard> cards, Activity activity) {
