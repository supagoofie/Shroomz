...
/**
 * Created by Riku/miika on 27.1.2016.
 */
public class ShroomzPensiveCard extends BasicCard {


        public static final int IMAGE_NUMBER = 14;
        private Animation pareFoundAnim;

        public ShroomzPensiveCard(Collection<BasicCard> cards, Activity activity) {
