 ...
 */
    ...
    public class ShroomzRageCard extends BasicCard {


        public static final int IMAGE_NUMBER = 18;
        private Animation pareFoundAnim;

        public ShroomzRageCard(Collection<BasicCard> cards, Activity activity) {
