...
/**
 * Created by lammi on 29.1.2016.
 */
public class ShroomzCyborgCard  extends BasicCard {
    public static final int IMAGE_NUMBER = 19;
    private Animation pareFoundAnim;

    public ShroomzCyborgCard(Collection<BasicCard> cards, Activity activity) {
